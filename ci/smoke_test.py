...
1. the vendored OCP package imports and the STEP reader is reachable;
2. the built stepper_native module loads against its native_libs OCCT
...
print(f"OK: stepper_native handoff — {n_faces} faces, "
