...
class ImportStepCADOperator(bpy.types.Operator, ImportHelper):
    ...
    separate_solids: bpy.props.BoolProperty(
        ...
        description="Give every body of a multibody part its own object. "
                    "For files that hold several solids, shells or surfaces "
                    "with no assembly structure to tell them apart",
        default=False,
    )
    ...
    group_in_collection: bpy.props.BoolProperty(
        ...
        description="Put everything this file creates under one collection "
                    "named after it, so a second import does not interleave "
                    "with the first and the whole assembly moves, hides and "
                    "deletes as a unit",
        default=False,
    )
...
class STEP_AddonPreferences(bpy.types.AddonPreferences):
    ...
    matdb_dir: bpy.props.StringProperty(
        ...
        description="Folder holding the .blend material databases. Leave "
                    "empty to use the MaterialDB folder inside the addon — "
                    "which every reinstall wipes, and which cannot be shared "
    ...
    enable_bridge: bpy.props.BoolProperty(
        ...
        description="Show the SW To Blender sidebar tab and listen on "
                    "localhost so the SolidWorks add-in can send exports "
                    "straight into this Blender instance. Off by default: "
                    "the feature is still experimental, and the listener "
                    "accepts connections only from this machine",
        default=False,
